...
namespace KYCProcessPassportWebjob.AbbyyCloudOCR
{
    ...
    public class RestServiceClient
    {
        ...
        /// </summary>
        public void waitAndDownload(OcrSdkTask task, string outputFilePath)
        {
            ...
            if (task.Status == TaskStatus.Completed)
            {
                ...
                DownloadResult(task, outputFilePath);
        ...
        private void WriteFileToRequest(Stream blob, WebRequest request)
        {
            using (BinaryReader reader = new BinaryReader(blob))
            {
